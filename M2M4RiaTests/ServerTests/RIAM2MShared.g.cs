...
this.Write("\"\r\n//\r\n");
		...
		foreach(AssociationType association in associations)
		{
			...
			m2mAssociationSet.Entity1ToLink.LinkTableNavProp = Code.Escape(association) + "To" + Code.Escape(entity1);
			...
			m2mAssociationSet.Entity2ToLink.LinkTableNavProp = Code.Escape(association) + "To" + Code.Escape(entity2);
